...
var boxGender = (0, _jquery2.default)('#gender');
var boxCategoria = (0, _jquery2.default)('#category');
var boxOfficial = (0, _jquery2.default)('#official');
var boxSubOfficial = (0, _jquery2.default)('#subOfficial');

// seleccion de inputs
var inputsGender = (0, _jquery2.default)('input[name="genero"]');
var inputsCategory = (0, _jquery2.default)('input[name="categoria"]');
var inputsRange = (0, _jquery2.default)('input[name="grado"]');

var enviarDatos = (0, _jquery2.default)('#send');
var url;
...
function userName(user) {
	...
	console.log(user);
	var userTemplate = templateUser.replace(':name:', user.name).replace(':img:', user.photo);

	url = '/plataforma/start/save/' + user._id + '?_method=put';

	$userTemplate = (0, _jquery2.default)(userTemplate);
	(0, _jquery2.default)('#header').append($userTemplate);
	enviarDatos.attr('href', '/plataforma/start/save/' + user._id + '?_method=put');
}

templateUser = '<div>' + '<h2>Cuentanos más sobre ti</h2>' + '<h3>¡Hola :name:!</h3>' + '<img src=":img:" alt=":name:">' + '</div>';

(0, _page2.default)('/view/formulario.html', function (ctx, next) {
	console.log(ctx);
	...
	function sendDate(ev) {
		...
		_jquery2.default.ajax({
			...
			data: data,
			url: url,
			success: function success(contenido) {
...
},{"jquery":3,"page":4}],3:[function(require,module,exports){
/*!
...
},{"_process":1,"path-to-regexp":5}],5:[function(require,module,exports){
